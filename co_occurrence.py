...
def distinct_words(corpus):
    ...
    ### SOLUTION BEGIN
    corpus_words = set(w for list in corpus for w in list)
...
def reduce_to_k_dim(M, k=2):
    ...
    ### SOLUTION BEGIN
    tsvd = TruncatedSVD(n_components=k, n_iter=n_iters, random_state=4355)
...
def test_distinct_words():
    ...
    print(
        "Words in corpus: {}\n Number of words in corpus: {}\n".format(
            ans_test_corpus_words, ans_num_corpus_words
        )
    )
...
def test_compute_co_occurrence_matrix():
    ...
    print(
        "Shape of co-occurrence matrix: {}\n Word to index map: {}\n".format(
            M_test_ans.shape, word2Ind_test_ans
        )
    )
...
def test_reduce_to_k_dim():
    ...
    print("\nExpected Result:")
    print("Shape of reduced dim co-occurrence matrix: {}\n".format((10, 2)))
